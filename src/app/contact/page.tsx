      ...
      <div className={styles.layout}>
        ...
        <aside className={styles.infoCol}>
          ...
          <div className={styles.whatsappCard}>
            <h3 className={styles.whatsappTitle}>💬 Quick WhatsApp Support</h3>
            ...
            <a
              href="https://wa.me/911234567890?text=Hi!%20I%20have%20a%20question%20about%20Ditvi%20Crochet%20products."
              target="_blank"
              rel="noreferrer"
